...
Custom Music
Place a music file with the given name in the .mincraft/config/dsmmusic folder:
Dungeon music: dungeon.wav
Blood room music: bloodroom.wav
Dungeon boss music: dungeonboss.wav
Either run /dsmmusic reload or restart your game.
Enable the custom music in /dsm.
(Optional) Change the volume of the music with /dsmmusic volume.
Notes
